...
object HtmlTagName {
    ...
    inline val caption: TagName<HTMLTableCaptionElement>
        get() = TagName("caption")
    ...
    inline val head: TagName<HTMLHeadElement>
        get() = TagName("head")
    ...
    inline val menu: TagName<HTMLMenuElement>
        get() = TagName("menu")
    ...
    inline val picture: TagName<HTMLPictureElement>
        get() = TagName("picture")
    ...
    inline val search: TagName<HTMLElement>
        get() = TagName("search")
