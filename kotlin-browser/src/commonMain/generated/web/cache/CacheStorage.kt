 ...
 */
suspend inline fun CacheStorage.delete(cacheName: String): JsBoolean {
    return awaitPromiseLike(deleteAsync(cacheName))
}
 ...
 */
suspend inline fun CacheStorage.has(cacheName: String): JsBoolean {
    return awaitPromiseLike(hasAsync(cacheName))
}
