 ...
 */
suspend inline fun StorageManager.persist(): JsBoolean {
    return awaitPromiseLike(persistAsync())
}
 ...
 */
suspend inline fun StorageManager.persisted(): JsBoolean {
    return awaitPromiseLike(persistedAsync())
}
