...
var StyledElement.backgroundPosition: RelativePosition
    get() = RelativePosition(declarations["backgroundPosition"] as String)
    set(position) = put("backgroundPosition", position.value)
...
var StyledElement.gridArea: GridArea by CssProperty()
