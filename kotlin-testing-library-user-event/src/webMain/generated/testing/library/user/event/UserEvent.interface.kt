...
external interface UserEvent {
    ...
    @JsName("clear")
    fun clearAsync(element: web.dom.Element): js.promise.Promise<js.void.Void>

    @seskar.js.JsAsync
    suspend fun clear(element: web.dom.Element): js.void.Void
    ...
    @JsName("paste")
    fun pasteAsync(): js.promise.Promise<js.void.Void>
    ...
    @seskar.js.JsAsync
    suspend fun paste(): js.void.Void
    ...
    @JsName("tab")
    fun tabAsync(options: DirectTabOptions = definedExternally): js.promise.Promise<js.void.Void>

    @seskar.js.JsAsync
    suspend fun tab(options: DirectTabOptions = definedExternally): js.void.Void
}
