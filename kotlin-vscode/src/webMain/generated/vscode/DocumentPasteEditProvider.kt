...
external interface DocumentPasteEditProvider<T : DocumentPasteEdit> {
     ...
     *
     * Note that currently any changes to the [DataTransfer] are isolated to the current editor window.
     ...
     * later use in [provideDocumentPasteEdits]. This object is only valid for the duration of this method.
     ...
     * @param ranges Range in the [document] to paste into.
     ...
     * [DocumentPasteEdit] is applied at a time. If multiple edits are returned from all providers, then
     ...
     * Resolve can only be used to change [DocumentPasteEdit.insertText] or [DocumentPasteEdit.additionalEdit].
     *
     * @param pasteEdit The [DocumentPasteEdit] to resolve.
     * @param token A cancellation token.
     *
