 ...
 */
open external class ImageryLayerFeatureInfo {
    /**
     ...
     */
    fun configureNameFromProperties(properties: JsAny)
     ...
     */
    fun configureDescriptionFromProperties(properties: JsAny)
}
