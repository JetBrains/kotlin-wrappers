...
open external class Cesium3DTileset(
     ...
     * @property [heightReference] Sets the [HeightReference] for features in vector tilesets.
    ...
    interface ConstructorOptions {
        ...
        val modelUpAxis: Axis?
        val modelForwardAxis: Axis?
        val shadows: ShadowMode?
        val maximumScreenSpaceError: Int?
        val cacheBytes: Int?
        val maximumCacheOverflowBytes: Int?
        val cullWithChildrenBounds: Boolean?
        val cullRequestsWhileMoving: Boolean?
        val cullRequestsWhileMovingMultiplier: Double?
        val preloadWhenHidden: Boolean?
        val preloadFlightDestinations: Boolean?
        val preferLeaves: Boolean?
        val dynamicScreenSpaceError: Boolean?
        val dynamicScreenSpaceErrorDensity: Double?
        val dynamicScreenSpaceErrorFactor: Double?
        val dynamicScreenSpaceErrorHeightFalloff: Double?
        val progressiveResolutionHeightFraction: Double?
        val foveatedScreenSpaceError: Boolean?
        val foveatedConeSize: Double?
        val foveatedMinimumScreenSpaceErrorRelaxation: Double?
        val foveatedInterpolationCallback: FoveatedInterpolationCallback?
        val foveatedTimeDelay: Double?
        val skipLevelOfDetail: Boolean?
        val baseScreenSpaceError: Int?
        val skipScreenSpaceErrorFactor: Int?
        val skipLevels: Int?
        val immediatelyLoadDesiredLevelOfDetail: Boolean?
        val loadSiblings: Boolean?
        ...
        val debugShowGeometricError: Boolean?
        val debugShowRenderingStatistics: Boolean?
        val debugShowMemoryUsage: Boolean?
        val debugShowUrl: Boolean?
    }
