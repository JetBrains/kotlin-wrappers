...
typealias AllByBoundAttribute<T /*  : HTMLElement default is HTMLElement */> = (container: HTMLElement, id: Matcher, options: MatcherOptions? /* use undefined for default */) -> js.array.ReadonlyArray<T>
