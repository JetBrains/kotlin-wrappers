...
typealias FindByText<T /*  : HTMLElement default is HTMLElement */> = (container: HTMLElement, id: Matcher, options: SelectorMatcherOptions? /* use undefined for default */, waitForElementOptions: waitForOptions? /* use undefined for default */) -> Promise<T>
