...
typealias FindByBoundAttribute<T /*  : HTMLElement default is HTMLElement */> = (container: HTMLElement, id: Matcher, options: MatcherOptions? /* use undefined for default */, waitForElementOptions: waitForOptions? /* use undefined for default */) -> Promise<T>
