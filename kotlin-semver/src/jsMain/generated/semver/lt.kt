...
@file:JsModule("semver/functions/lt")
 ...
 * v1 < v2
 */
external fun lt(v1: String, v2: String, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 < v2
 */
external fun lt(v1: String, v2: SemVer, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 < v2
 */
external fun lt(v1: SemVer, v2: String, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 < v2
 */
external fun lt(v1: SemVer, v2: SemVer, optionsOrLoose: semver.Options = definedExternally): Boolean
