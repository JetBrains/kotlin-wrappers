...
@file:JsModule("semver/functions/gte")
 ...
 * v1 >= v2
 */
external fun gte(v1: String, v2: String, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 >= v2
 */
external fun gte(v1: String, v2: SemVer, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 >= v2
 */
external fun gte(v1: SemVer, v2: String, optionsOrLoose: semver.Options = definedExternally): Boolean
 ...
 * v1 >= v2
 */
external fun gte(v1: SemVer, v2: SemVer, optionsOrLoose: semver.Options = definedExternally): Boolean
