 ...
 * Note the API signature is not stable and might change.
 */
external fun <T> transformImage(image: js.buffer.ArrayBuffer?): T
 ...
 * Note the API signature is not stable and might change.
 */
external fun <T> transformImage(image: js.array.ReadonlyArray<Double>?): T
