...
private constructor() {
    ...
    companion object {
        ...
        fun <T : JsAny, P : JsAny?> defineProperty(o: T, p: String, attributes: TypedPropertyDescriptor<P>): T
        ...
        fun <T : JsAny?> getOwnPropertyDescriptor(o: JsAny, p: String): TypedPropertyDescriptor<T>?
        ...
        fun hasOwn(o: JsAny, v: String): Boolean
