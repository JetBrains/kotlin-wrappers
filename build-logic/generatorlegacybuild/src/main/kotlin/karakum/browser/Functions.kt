...
private fun convertFunctionResult(
    ...
    val extensionsCollector = BrowserSuspendExtensionsCollector(parentName = null, parentTypeParameters = null)
    var body = if (jsName != null) {
        "$jsName\nexternal $declaration"
    } else {
        withSuspendExtensions(declaration, null, extensionsCollector)
