...
fun <R : JsAny?> async(
    ...
    createCancellablePromise(abortable, block)
}
...
fun <P1 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2, p3) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2, p3, p4) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2, p3, p4, p5) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2, p3, p4, p5, p6) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : JsAny?, P7 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(abortable) { block(p1, p2, p3, p4, p5, p6, p7) }
}
