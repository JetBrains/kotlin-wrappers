...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : AbortableLike, R : JsAny?> async(
    ...
    createCancellablePromise(p4.signal) { block(p1, p2, p3, p4) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : AbortableLike, R : JsAny?> async(
    ...
    createCancellablePromise(p5.signal) { block(p1, p2, p3, p4, p5) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : AbortableLike, R : JsAny?> async(
    ...
    createCancellablePromise(p6.signal) { block(p1, p2, p3, p4, p5, p6) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : JsAny?, P7 : AbortableLike, R : JsAny?> async(
    ...
    createCancellablePromise(p7.signal) { block(p1, p2, p3, p4, p5, p6, p7) }
}
...
fun <R : JsAny?> async(
    ...
    createCancellablePromise(signal, block)
}
...
fun <P1 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2, p3) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2, p3, p4) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2, p3, p4, p5) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2, p3, p4, p5, p6) }
}
...
fun <P1 : JsAny?, P2 : JsAny?, P3 : JsAny?, P4 : JsAny?, P5 : JsAny?, P6 : JsAny?, P7 : JsAny?, R : JsAny?> async(
    ...
    createCancellablePromise(signal) { block(p1, p2, p3, p4, p5, p6, p7) }
}
