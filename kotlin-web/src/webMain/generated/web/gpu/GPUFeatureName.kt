...
sealed /* union */
external interface GPUFeatureName {
    companion object
}
...
inline val GPUFeatureName.Companion.clipDistances: GPUFeatureName
    get() = unsafeCast("clip-distances")

inline val GPUFeatureName.Companion.coreFeaturesAndLimits: GPUFeatureName
    get() = unsafeCast("core-features-and-limits")
...
inline val GPUFeatureName.Companion.dualSourceBlending: GPUFeatureName
    get() = unsafeCast("dual-source-blending")

inline val GPUFeatureName.Companion.float32Blendable: GPUFeatureName
    get() = unsafeCast("float32-blendable")
...
inline val GPUFeatureName.Companion.primitiveIndex: GPUFeatureName
    get() = unsafeCast("primitive-index")
...
inline val GPUFeatureName.Companion.subgroups: GPUFeatureName
    get() = unsafeCast("subgroups")

inline val GPUFeatureName.Companion.textureCompressionAstc: GPUFeatureName
    get() = unsafeCast("texture-compression-astc")

inline val GPUFeatureName.Companion.textureCompressionAstcSliced3d: GPUFeatureName
    get() = unsafeCast("texture-compression-astc-sliced-3d")

inline val GPUFeatureName.Companion.textureCompressionBc: GPUFeatureName
    get() = unsafeCast("texture-compression-bc")

inline val GPUFeatureName.Companion.textureCompressionBcSliced3d: GPUFeatureName
    get() = unsafeCast("texture-compression-bc-sliced-3d")

inline val GPUFeatureName.Companion.textureCompressionEtc2: GPUFeatureName
    get() = unsafeCast("texture-compression-etc2")

inline val GPUFeatureName.Companion.textureFormatsTier1: GPUFeatureName
    get() = unsafeCast("texture-formats-tier1")
