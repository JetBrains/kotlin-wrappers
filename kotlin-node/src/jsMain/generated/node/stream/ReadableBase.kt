...
open external class ReadableBase : Stream, node.ReadableStream {
     ...
     * 7. resume
     */
    fun addListener(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.ERROR, listener: (err: Throwable /* JsError */) -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun addListener(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
    ...
    fun emit(event: ReadableBaseEvent.CLOSE): Boolean
    fun emit(event: ReadableBaseEvent.DATA, chunk: Any?): Boolean
    fun emit(event: ReadableBaseEvent.END): Boolean
    fun emit(event: ReadableBaseEvent.ERROR, err: Throwable /* JsError */): Boolean
    fun emit(event: ReadableBaseEvent.PAUSE): Boolean
    fun emit(event: ReadableBaseEvent.READABLE): Boolean
    fun emit(event: ReadableBaseEvent.RESUME): Boolean
    open fun emit(event: String, vararg args: Any?): Boolean

    open fun emit(event: js.symbol.Symbol, vararg args: Any?): Boolean
    fun on(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.ERROR, listener: (err: Throwable /* JsError */) -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun on(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
    ...
    fun once(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.ERROR, listener: (err: Throwable /* JsError */) -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun once(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
    ...
    fun prependListener(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun prependListener(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun prependListener(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun prependListener(
        event: ReadableBaseEvent.ERROR,
        listener: (err: Throwable /* JsError */) -> Unit,
    ): Unit /* this */

    fun prependListener(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun prependListener(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun prependListener(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
    ...
    fun prependOnceListener(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun prependOnceListener(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun prependOnceListener(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun prependOnceListener(
        event: ReadableBaseEvent.ERROR,
        listener: (err: Throwable /* JsError */) -> Unit,
    ): Unit /* this */

    fun prependOnceListener(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun prependOnceListener(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun prependOnceListener(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
    ...
    fun removeListener(event: ReadableBaseEvent.CLOSE, listener: () -> Unit): Unit /* this */
    fun removeListener(event: ReadableBaseEvent.DATA, listener: (chunk: Any?) -> Unit): Unit /* this */
    fun removeListener(event: ReadableBaseEvent.END, listener: () -> Unit): Unit /* this */
    fun removeListener(
        event: ReadableBaseEvent.ERROR,
        listener: (err: Throwable /* JsError */) -> Unit,
    ): Unit /* this */

    fun removeListener(event: ReadableBaseEvent.PAUSE, listener: () -> Unit): Unit /* this */
    fun removeListener(event: ReadableBaseEvent.READABLE, listener: () -> Unit): Unit /* this */
    fun removeListener(event: ReadableBaseEvent.RESUME, listener: () -> Unit): Unit /* this */
