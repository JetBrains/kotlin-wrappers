 ...
 */
@JsName("readFile")
external fun readFileAsync(path: PathLike): js.promise.Promise<Any /* string | NonSharedBuffer */>
 ...
 */
@JsName("readFile")
external fun readFileAsync(path: FileHandle): js.promise.Promise<Any /* string | NonSharedBuffer */>
