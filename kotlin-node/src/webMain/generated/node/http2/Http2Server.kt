...
sealed external interface Http2Server<Http1Request : IncomingMessage, Http1Response : ServerResponse<*>, Http2Request : Http2ServerRequest, Http2Response : Http2ServerResponse<*>> :
    node.net.Server,
    HTTP2ServerCommon {
