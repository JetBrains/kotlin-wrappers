...
open external class Http2ServerResponse<Request : Http2ServerRequest /* default is Http2ServerRequest */> :
     ...
     * @since v8.4.0
     */
    fun addTrailers(trailers: OutgoingHttpHeaders)
     ...
     * @since v18.11.0
     */
    fun writeEarlyHints(hints: js.objects.ReadonlyRecord<String, Any /* string | string[] */>)
     ...
     * @since v8.4.0
     */
    fun writeHead(statusCode: Number, headers: js.array.ReadonlyArray<String> = definedExternally) // this
