...
external interface PopperUnstyledTransitionProps : react.Props {
    var `in`: Boolean
...
external interface PopperUnstyledChildrenProps : react.Props {
    var placement: popper.core.Placement

    var TransitionProps: PopperUnstyledTransitionProps?
}
