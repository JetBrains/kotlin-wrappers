...
external interface RenderResult<Container : Any? /* RendererableContainer | HydrateableContainer */ /* default is web.html.HTMLElement */, BaseElement : Any? /* RendererableContainer | HydrateableContainer */ /* default is Container */> :
    ...
    var unmount: () -> Unit
    var asFragment: () -> web.dom.DocumentFragment
}
