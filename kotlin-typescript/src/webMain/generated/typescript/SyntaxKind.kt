...
sealed external interface SyntaxKind {
    ...
    sealed interface EndOfFileToken :
        SyntaxKind,
        TokenSyntaxKind,
        JsxTokenSyntaxKind,
        JSDocSyntaxKind

    sealed interface SingleLineCommentTrivia :
        SyntaxKind,
        TriviaSyntaxKind,
        CommentKind

    sealed interface MultiLineCommentTrivia :
        SyntaxKind,
        TriviaSyntaxKind,
        CommentKind

    sealed interface NewLineTrivia :
        SyntaxKind,
        TriviaSyntaxKind,
        JSDocSyntaxKind

    sealed interface WhitespaceTrivia :
        SyntaxKind,
        TriviaSyntaxKind,
        JSDocSyntaxKind

    sealed interface ShebangTrivia :
        SyntaxKind,
        TriviaSyntaxKind

    sealed interface ConflictMarkerTrivia :
        SyntaxKind,
        TriviaSyntaxKind,
        JsxTokenSyntaxKind
    ...
    sealed interface NumericLiteral :
        SyntaxKind,
        LiteralSyntaxKind

    sealed interface BigIntLiteral :
        SyntaxKind,
        LiteralSyntaxKind

    sealed interface StringLiteral :
        SyntaxKind,
        LiteralSyntaxKind

    sealed interface JsxText :
        SyntaxKind,
        LiteralSyntaxKind,
        JsxTokenSyntaxKind

    sealed interface JsxTextAllWhiteSpaces :
        SyntaxKind,
        LiteralSyntaxKind,
        JsxTokenSyntaxKind

    sealed interface RegularExpressionLiteral :
        SyntaxKind,
        LiteralSyntaxKind

    sealed interface NoSubstitutionTemplateLiteral :
        SyntaxKind,
        LiteralSyntaxKind

    sealed interface TemplateHead :
        SyntaxKind,
        PseudoLiteralSyntaxKind

    sealed interface TemplateMiddle :
        SyntaxKind,
        PseudoLiteralSyntaxKind

    sealed interface TemplateTail :
        SyntaxKind,
        PseudoLiteralSyntaxKind

    sealed interface OpenBraceToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JsxTokenSyntaxKind,
        JSDocSyntaxKind

    sealed interface CloseBraceToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface OpenParenToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface CloseParenToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface OpenBracketToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface CloseBracketToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface DotToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface DotDotDotToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface SemicolonToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface CommaToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind,
        BinaryOperator

    sealed interface QuestionDotToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface LessThanToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JsxTokenSyntaxKind,
        JSDocSyntaxKind,
    ...
    sealed interface LessThanSlashToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JsxTokenSyntaxKind

    sealed interface GreaterThanToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind,
        RelationalOperator

    sealed interface LessThanEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        RelationalOperator

    sealed interface GreaterThanEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        RelationalOperator

    sealed interface EqualsEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        EqualityOperator

    sealed interface ExclamationEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        EqualityOperator

    sealed interface EqualsEqualsEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        EqualityOperator

    sealed interface ExclamationEqualsEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        EqualityOperator

    sealed interface EqualsGreaterThanToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface PlusToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator,
        AdditiveOperator

    sealed interface MinusToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator,
        AdditiveOperator

    sealed interface AsteriskToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind,
        MultiplicativeOperator

    sealed interface AsteriskAsteriskToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface SlashToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        MultiplicativeOperator

    sealed interface PercentToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        MultiplicativeOperator

    sealed interface PlusPlusToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator,
        PostfixUnaryOperator

    sealed interface MinusMinusToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator,
        PostfixUnaryOperator

    sealed interface LessThanLessThanToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        ShiftOperator

    sealed interface GreaterThanGreaterThanToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        ShiftOperator

    sealed interface GreaterThanGreaterThanGreaterThanToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        ShiftOperator

    sealed interface AmpersandToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        BitwiseOperator

    sealed interface BarToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        BitwiseOperator

    sealed interface CaretToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        BitwiseOperator

    sealed interface ExclamationToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator

    sealed interface TildeToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        PrefixUnaryOperator

    sealed interface AmpersandAmpersandToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        LogicalOperator

    sealed interface BarBarToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        LogicalOperator

    sealed interface QuestionToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface ColonToken :
        SyntaxKind,
        PunctuationSyntaxKind

    sealed interface AtToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface QuestionQuestionToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        AssignmentOperatorOrHigher

    sealed interface BacktickToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface HashToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind

    sealed interface EqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        JSDocSyntaxKind,
        AssignmentOperator

    sealed interface PlusEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface MinusEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface AsteriskEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface AsteriskAsteriskEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface SlashEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface PercentEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface LessThanLessThanEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface GreaterThanGreaterThanEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface GreaterThanGreaterThanGreaterThanEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface AmpersandEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface BarEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator

    sealed interface BarBarEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator,
        LogicalOrCoalescingAssignmentOperator

    sealed interface AmpersandAmpersandEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator,
        LogicalOrCoalescingAssignmentOperator

    sealed interface QuestionQuestionEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator,
        LogicalOrCoalescingAssignmentOperator

    sealed interface CaretEqualsToken :
        SyntaxKind,
        PunctuationSyntaxKind,
        CompoundAssignmentOperator
    ...
    sealed interface BreakKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface CaseKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface CatchKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ClassKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ConstKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface ContinueKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface DebuggerKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface DefaultKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface DeleteKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface DoKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ElseKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface EnumKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ExportKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface ExtendsKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        HeritageClauseToken

    sealed interface FalseKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface FinallyKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ForKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface FunctionKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface IfKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ImportKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        MetaPropertyKeywordToken

    sealed interface InKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind,
        RelationalOperator

    sealed interface InstanceOfKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        RelationalOperator

    sealed interface NewKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        MetaPropertyKeywordToken

    sealed interface NullKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface ReturnKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface SuperKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface SwitchKeyword :
        SyntaxKind,
        KeywordSyntaxKind
    ...
    sealed interface ThrowKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface TrueKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface TryKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface TypeOfKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface VarKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface VoidKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface WhileKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface WithKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ImportAttributesToken

    sealed interface ImplementsKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        HeritageClauseToken

    sealed interface InterfaceKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface LetKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface PackageKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface PrivateKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface ProtectedKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface PublicKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface StaticKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface YieldKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface AbstractKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface AccessorKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface AsKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface AssertsKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface AssertKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ImportAttributesToken

    sealed interface AnyKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface AsyncKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface AwaitKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface BooleanKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface ConstructorKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface DeclareKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface GetKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface InferKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface IntrinsicKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface IsKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface KeyOfKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        TypeOperatorNodeOperator

    sealed interface ModuleKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface NamespaceKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface NeverKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface OutKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind

    sealed interface ReadonlyKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind,
        TypeOperatorNodeOperator

    sealed interface RequireKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface NumberKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface ObjectKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface SatisfiesKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface SetKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface StringKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface SymbolKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind
    ...
    sealed interface UniqueKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        TypeOperatorNodeOperator

    sealed interface UnknownKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface UsingKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface FromKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface GlobalKeyword :
        SyntaxKind,
        KeywordSyntaxKind

    sealed interface BigIntKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        KeywordTypeSyntaxKind

    sealed interface OverrideKeyword :
        SyntaxKind,
        KeywordSyntaxKind,
        ModifierSyntaxKind
    ...
    sealed interface FunctionType :
        SyntaxKind,
        FunctionOrConstructorTypeNodeBaseKind

    sealed interface ConstructorType :
        SyntaxKind,
        FunctionOrConstructorTypeNodeBaseKind
    ...
    sealed interface ClassExpression :
        SyntaxKind,
        ClassLikeDeclarationBaseKind
