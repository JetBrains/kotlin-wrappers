...
external interface ColumnPinningInstance<TData : RowData> {
     ...
     */
    val getCenterLeafColumns: () -> ReadonlyArray<Column<TData, *>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-pinning)
     */
    val getIsSomeColumnsPinned: (position: ColumnPinningPosition?) -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-pinning)
     */
    val getLeftLeafColumns: () -> ReadonlyArray<Column<TData, *>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-pinning)
     */
    val getRightLeafColumns: () -> ReadonlyArray<Column<TData, *>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-pinning)
     */
    val resetColumnPinning: (defaultState: Boolean?) -> Unit
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-pinning)
     */
    val setColumnPinning: (updater: Updater<ColumnPinningState>) -> Unit
}
