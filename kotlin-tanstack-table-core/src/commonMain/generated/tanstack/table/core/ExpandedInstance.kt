...
external interface ExpandedInstance<TData : RowData> {
     ...
     */
    val getCanSomeRowsExpand: () -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val getExpandedRowModel: () -> RowModel<TData>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val getIsAllRowsExpanded: () -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val getIsSomeRowsExpanded: () -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val getPreExpandedRowModel: () -> RowModel<TData>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val getToggleAllRowsExpandedHandler: () -> (event: Any) -> Unit
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val resetExpanded: (defaultState: Boolean?) -> Unit
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val setExpanded: (updater: Updater<ExpandedState>) -> Unit
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/expanding)
     */
    val toggleAllRowsExpanded: (expanded: Boolean?) -> Unit
}
