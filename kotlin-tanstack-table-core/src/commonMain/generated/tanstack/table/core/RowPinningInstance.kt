...
external interface RowPinningInstance<TData : RowData> {
     ...
     */
    val getBottomRows: () -> ReadonlyArray<Row<TData>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/row-pinning)
     */
    val getCenterRows: () -> ReadonlyArray<Row<TData>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/row-pinning)
     */
    val getIsSomeRowsPinned: (position: RowPinningPosition?) -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/row-pinning)
     */
    val getTopRows: () -> ReadonlyArray<Row<TData>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/row-pinning)
     */
    val resetRowPinning: (defaultState: Boolean?) -> Unit
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/row-pinning)
     */
    val setRowPinning: (updater: Updater<RowPinningState>) -> Unit
}
