...
external interface SortingColumn<TData : RowData> {
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getAutoSortDir: () -> SortDirection
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getAutoSortingFn: () -> SortingFn<TData>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getFirstSortDir: () -> SortDirection
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getNextSortingOrder: () -> SortDirection?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getSortingFn: () -> SortingFn<TData>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getToggleSortingHandler: () -> ((event: Any) -> Unit)?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val toggleSorting: (desc: Boolean?, isMulti: Boolean?) -> Unit
}
