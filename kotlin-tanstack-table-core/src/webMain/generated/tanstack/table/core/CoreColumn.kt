...
external interface CoreColumn<TData : RowData, TValue> {
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-defs)
     */
    val columns: ReadonlyArray<Column<TData, TValue>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-defs)
     */
    val getFlatColumns: () -> ReadonlyArray<Column<TData, TValue>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-defs)
     */
    val getLeafColumns: () -> ReadonlyArray<Column<TData, TValue>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-defs)
     */
    val parent: Column<TData, TValue>?
}
