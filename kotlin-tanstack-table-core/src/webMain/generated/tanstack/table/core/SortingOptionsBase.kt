...
external interface SortingOptionsBase<TData : RowData> {
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val enableSortingRemoval: Boolean?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val getSortedRowModel: ((table: Table<TData>) -> () -> RowModel<TData>)?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val isMultiSortEvent: ((e: Any) -> Boolean)?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/sorting)
     */
    val onSortingChange: OnChangeFn<SortingState>?
