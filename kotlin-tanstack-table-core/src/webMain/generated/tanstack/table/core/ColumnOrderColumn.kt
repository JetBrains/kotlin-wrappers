...
external interface ColumnOrderColumn {
     ...
     */
    val getIndex: (position: ColumnOrderPosition?) -> Int
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-ordering)
     */
    val getIsFirstColumn: (position: ColumnOrderPosition?) -> Boolean
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/column-ordering)
     */
    val getIsLastColumn: (position: ColumnOrderPosition?) -> Boolean
}
