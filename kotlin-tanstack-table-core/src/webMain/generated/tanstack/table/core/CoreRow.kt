...
external interface CoreRow<TData : RowData> {
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val getAllCells: () -> ReadonlyArray<Cell<TData, *>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val getLeafRows: () -> ReadonlyArray<Row<TData>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val getParentRows: () -> ReadonlyArray<Row<TData>>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val getUniqueValues: (columnId: String) -> ReadonlyArray<Any? /* TValue */>
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val getValue: (columnId: String) -> Any? /* TValue */
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val originalSubRows: ReadonlyArray<TData>?
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val renderValue: (columnId: String) -> Any? /* TValue */
     ...
     * [Guide](https://tanstack.com/table/v8/docs/guide/rows)
     */
    val subRows: ReadonlyArray<Row<TData>>
}
